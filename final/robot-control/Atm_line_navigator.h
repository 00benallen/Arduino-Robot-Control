...
class Atm_line_navigator: public Machine {
 ...
 private:
  enum { ENT_FOLLOW_LINE, LP_FOLLOW_LINE, ENT_IDENTIFY_INTERSECTION, LP_IDENTIFY_INTERSECTION, ENT_INTERSECTION_TURN, LP_INTERSECTION_TURN, ENT_INTERSECTION_ALIGN, LP_INTERSECTION_ALIGN, ENT_CALIBRATING }; // ACTIONS
  int event( int id ); 
  void action( int id );
